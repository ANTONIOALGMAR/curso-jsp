...
public class DAOUsuarioRepository {
	...
	public ArrayList<ModelLogin> consultaUsuarioListRel(Long userLogado) throws Exception {
		
		ArrayList<ModelLogin> retorno = new ArrayList<ModelLogin>();
