											...
											<div class="col-sm-12">
												...
												<div class="card">
													...
													<div class="card-block">
														...
														<form class="form-material" action="<%=request.getContextPath()%>/UsuarioController" method="get" id="formUser">
															...
															<div class="form-row align-items-center">
																...
																<div class="col-sm-3 my-1">
																	...
																	<input value="${dataInicial}" type="text" class="form-control"
																		id="dataInicial" name="dataInicial" placeholder="Data Inicial">
																</div>
